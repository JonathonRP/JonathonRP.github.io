...
declare module '../Enumerable' {
	interface Enumerable<T> {
		selectMany<TOut>(this: Enumerable<T>, selector: IndexedSelector<T, Iterable<TOut>>): Enumerable<TOut>;
	}
}

function selectMany<T, TOut>(this: Enumerable<T>, selector: IndexedSelector<T, Iterable<TOut>>): Enumerable<TOut> {
	const src = this;
