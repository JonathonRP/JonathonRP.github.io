...
declare module '../Enumerable' {
	interface Enumerable<T> {
		...
		singleOrDefault(this: Enumerable<T>, pred: IndexedPredicate<T>): T | undefined;
	}
}

const dummy: any = {};

function singleOrDefault<T>(this: Enumerable<T>, pred: IndexedPredicate<T> = (x) => true): T | undefined {
	let itemCount = 0;
	let foundItem = dummy;
	let i = 0;
