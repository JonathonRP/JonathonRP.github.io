...
export const createHashTable = <TKey, TValue>(
	...
	const buckets: KeyValuePair<TKey, TValue>[][] =
		initializeArrayForCapacity<KeyValuePair<TKey, TValue>[]>(idealNumBuckets);
	return new HashTable<TKey, TValue>(buckets, count, avgBucketFill, capacity, comparer, createHashTable);
};
