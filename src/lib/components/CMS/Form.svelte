<script>
  ...
  import { settingsStore, pauseFlash } from './settingStore.js';
...
<SideMenu {theme} {nub} {top} links={[]} active={isToyActive}>
  <div
    ...
    style="--state-tool-font-size: {$settingsStore.pxFontSize}px">
    <input
      type="text"
      id="filter"
      bind:this={filterRef}
  ...
  <div
    ...
    style="--state-tool-font-size: {$settingsStore.pxFontSize}px">
    <FormGroup store={settingsStore} label={'SVELTE-TOY SETTINGS'} />
