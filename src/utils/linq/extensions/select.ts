...
declare module '../Enumerable' {
	interface Enumerable<T> {
		select<TOut>(this: Enumerable<T>, selector: IndexedSelector<T, TOut>): Enumerable<TOut>;
	}
}

function select<T, TOut>(this: Enumerable<T>, selector: IndexedSelector<T, TOut>): Enumerable<TOut> {
	const src = this;
