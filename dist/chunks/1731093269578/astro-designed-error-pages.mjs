import { escape, DEFAULT_404_COMPONENT } from './astro/server.mjs';
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://JonathonRP.github.io", "SSR": true};
...
export { DEFAULT_404_ROUTE, NOOP_MIDDLEWARE_FN, default404Instance, deserializeActionResult, getActionQueryString };
